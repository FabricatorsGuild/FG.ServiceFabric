...
using FG.ServiceFabric.Actors.Diagnostics.Tracing;
using FG.ServiceFabric.Services.Diagnostics.Tracing;
using Microsoft.ServiceFabric.Actors.Runtime;

namespace FG.ServiceFabric.Common.ActorDemo
{
    [EventSource(Name = "FFCG-ServiceFabric-Demo")]
    internal sealed class ActorEventSource : EventSource, IServiceEventSource, IActorEventSource
    {
        ...
        public void ServiceReplicaListenerMessage(
            string serviceName,
            string serviceTypeName,
            long replicaOrInstanceId,
            Guid partitionId,
        ...
        public void ServiceReplicaListenerError(
            string serviceName,
            string serviceTypeName,
            long replicaOrInstanceId,
            Guid partitionId,
        ...
        [Event(ActorMessageEventId, Level = EventLevel.Informational, Message = "{7}", Keywords = Keywords.ActorImplementation)]
        ...
        [NonEvent]
        public void ActorError(Actor actor, string message, Exception exception)
        {
            if (this.IsEnabled())
            {
                var exceptionMessage = exception.ToString();
        ...
        [Event(ActorErrorEventId, Level = EventLevel.Error, Message = "{7} - {8}", Keywords = Keywords.ActorImplementation)]
        ...
        [NonEvent]
        public void ActorDemoCountSet(Actor actor, int count)
        {
            if (this.IsEnabled())
            {
                ActorDemoCountSet(
        ...
        [Event(ActorDemoCountSetEventId, Level = EventLevel.Error, Message = "{7}", Keywords = Keywords.ActorImplementation)]
        ...
        [NonEvent]
        public void ActorDemoCountUpdated(Actor actor, int count)
        {
            if (this.IsEnabled())
            {
