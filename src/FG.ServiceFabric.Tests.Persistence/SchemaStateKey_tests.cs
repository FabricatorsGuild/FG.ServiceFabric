...
namespace FG.ServiceFabric.Tests.Persistence
{
	...
	public class With_SchemaStateKey
	{
		...
		public void Should_build_full_dictionary_key()
		{
			...
			var schemaStateKey = new SchemaStateKey(service, range, dictionaryStateKey?.Schema, dictionaryStateKey?.Key);
			...
			schemaStateKey.ToString().Should().Be("Core-PCSyncCompanyChannelAdapter_singleton_error_dictionary_48a46df3-843e-4645-b8de-075259c826f2");
		}
		...
		public void Should_build_ServiceName_with_fabric_schema()
		{
			...
			Console.Write($"{id} => '{schemaStateKey.ServiceName}', '{schemaStateKey.PartitionKey}', '{schemaStateKey.Schema}', '{schemaStateKey.Key}'");
		}
		...
		public void Should_handle_full_keys_with_underscore()
		{
			...
			Console.Write($"{schemaStateKey} => '{schemaStateKey.ServiceName}', '{schemaStateKey.PartitionKey}', '{schemaStateKey.Schema}', '{schemaStateKey.Key}'");
		}
