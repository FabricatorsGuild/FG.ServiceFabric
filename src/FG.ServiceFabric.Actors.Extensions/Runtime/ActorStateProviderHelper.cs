...
namespace FG.ServiceFabric.Actors.Runtime
{
    public class ActorStateProviderHelper
    {
        ...
        public static IActorStateProvider CreateDefaultStateProvider(ActorTypeInformation actorTypeInfo)
        {
            ...
            var createDefaultStateProviderMethod = internalActorStateProviderHelperType.GetMethod(
                "CreateDefaultStateProvider",
            ...
            Type actorImplType)
        {
            ...
            var endpoint =
                codePackage.GetEndpoint(ActorNameFormat.GetFabricServiceReplicatorEndpointName(actorImplType));
