...
namespace FG.ServiceFabric.Actors.State
{
    ...
    {
        private readonly Func<int, IActorStateProvider, ActorId, string, string, Task<TPredecessor>>
            _migratePredecessorStateProvider;
        ...
        public MigrationWithFunctions(
            ...
            Func<int, IActorStateProvider, ActorId, string, string, Task<TPredecessor>> migratePredecessorStateProvider
                = null
        ) : base(version)
        {
        ...
        protected override Task<TPredecessor> MigratePredecessor(int currentStateVersion,
