...
namespace FG.Common.Tests
{
    ...
    public class ReflectionUtils_tests
    {
        ...
        public void CallGenericMethod_for_non_generic_class_should_match_generic_method_arguments_exactly()
        {
            ...
            var callGenericMethodResult =
                new TestClass().CallGenericMethod(methodWithOneGenericArgName, new[] {typeof(Data2)}, "hello");
        ...
        [Test]
        public void
            CallGenericMethod_for_non_generic_class_should_match_generic_method_arguments_with_constraints_exactly()
        {
    ...
    public class TextUtils_test
    {
        ...
        {
            var collection = new[] {"first", "second", "third", "fourth", "fifth"};
