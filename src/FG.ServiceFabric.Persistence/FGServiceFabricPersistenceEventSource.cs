...
namespace FG.ServiceFabric
{
    ...
    {
        public static readonly FGServiceFabricPersistenceEventSource Current =
            new FGServiceFabricPersistenceEventSource();
        ...
        private FGServiceFabricPersistenceEventSource()
        {
        }
