...
namespace FG.ServiceFabric
{
	internal sealed partial class FGServiceFabricPersistenceEventSource
	{
		...
		[Event(StartingSessionEventId, Level = EventLevel.LogAlways, Message = "Starting Session {2}", Keywords = Keywords.DocumentDbStateSession)]
		...
		[Event(DocumentClientExceptionEventId, Level = EventLevel.LogAlways, Message = "{5}", Keywords = Keywords.DocumentDbStateSession | Keywords.Error)]
