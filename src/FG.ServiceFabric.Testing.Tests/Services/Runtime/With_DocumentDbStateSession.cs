...
using FG.ServiceFabric.Tests.StatefulServiceDemo.With_polymorphic_array_state;
using FluentAssertions;
using Microsoft.ServiceFabric.Services.Client;
using NUnit.Framework;
using IStatefulServiceDemo = FG.ServiceFabric.Tests.StatefulServiceDemo.With_simple_counter_state.IStatefulServiceDemo;
using StatefulServiceDemo = FG.ServiceFabric.Tests.StatefulServiceDemo.With_simple_counter_state.StatefulServiceDemo;
    ...
    namespace With_StateSessionManager
    {
        namespace and_DocumentDbStateSessionManagerWithTransaction
        {
                ...
                StatefulServiceDemo>
            {
                ...
                {
                    var service = new StatefulServiceDemo(context, stateSessionManager);
                    return service;
                }
                ...
                ServiceFabric.Tests.StatefulServiceDemo.With_polymorphic_array_state.StatefulServiceDemo>
            {
                ...
                protected override ServiceFabric.Tests.StatefulServiceDemo.With_polymorphic_array_state.
                    StatefulServiceDemo
                    CreateService(StatefulServiceContext context, IStateSessionManager stateSessionManager)
                {
                    var service =
                    ...
                    foreach (var service in Services)
                    {
                        ...
                        var innerStateItemA =
                            ...
                            serviceState.Items.Single(i =>
                                i is InnerStateItemTypeA);
                        var innerStateItemB =
                            (InnerStateItemTypeB)
                            serviceState.Items.Single(i =>
                                i is InnerStateItemTypeB);
