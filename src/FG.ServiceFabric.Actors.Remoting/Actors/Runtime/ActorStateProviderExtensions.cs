...
namespace FG.ServiceFabric.Actors.Runtime
{
    ...
    {
        public static Task<object> LoadStateAsync(this IActorStateProvider actorStateProvider, Type stateType,
            ActorId actorId, string stateName, CancellationToken cancellationToken)
        {
            ...
            var result =
                genericMethodInfo.Invoke(actorStateProvider, new object[] {actorId, stateName, cancellationToken});
