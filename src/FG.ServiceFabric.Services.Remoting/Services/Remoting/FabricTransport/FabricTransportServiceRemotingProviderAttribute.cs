...
namespace FG.ServiceFabric.Services.Remoting.FabricTransport
{
		...
		FabricTransport.FabricTransportServiceRemotingProviderAttribute
	{
		...
		{
			return this.OperationTimeoutInSeconds <= 0L
				? operationTimeout
				: TimeSpan.FromSeconds((double) this.OperationTimeoutInSeconds);
		}

		private TimeSpan GetKeepAliveTimeout(TimeSpan keepAliveTimeout)
		{
			return this.KeepAliveTimeoutInSeconds <= 0L
				? keepAliveTimeout
				: TimeSpan.FromSeconds((double) this.KeepAliveTimeoutInSeconds);
		}
