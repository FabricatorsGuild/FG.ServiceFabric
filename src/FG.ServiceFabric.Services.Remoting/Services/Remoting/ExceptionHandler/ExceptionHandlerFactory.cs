namespace FG.ServiceFabric.Services.Remoting.ExceptionHandler
{
    ...
    {
        public static IExceptionHandlerFactory Default { get; } = new CachingExceptionHandlerFactoryDecorator(new ExceptionHandlerFactory());
        ...
        {
            var attribute = typeToGetExceptionHandlerFor.Assembly.GetCustomAttribute<FabricTransportRemotingExceptionHandlerAttribute>();
