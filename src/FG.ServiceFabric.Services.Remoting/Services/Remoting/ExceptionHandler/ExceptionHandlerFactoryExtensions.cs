...
namespace FG.ServiceFabric.Services.Remoting.ExceptionHandler
{
    ...
    public static class ExceptionHandlerFactoryExtensions
    {
        ...
        public static IEnumerable<IExceptionHandler> GetExceptionHandlers(
            this IExceptionHandlerFactory exceptionHandlerFactory, Type actorInterfaceType,
            params Type[] additionalTypes)
        {
            return GetExceptionHandlersInternal(exceptionHandlerFactory, actorInterfaceType, additionalTypes)
                .Where(exceptionHandler => exceptionHandler != null);
        }

        private static IEnumerable<IExceptionHandler> GetExceptionHandlersInternal(
            this IExceptionHandlerFactory exceptionHandlerFactory, Type actorInterfaceType,
            params Type[] additionalTypes)
        {
