...
namespace FG.ServiceFabric.Services.Remoting.Runtime
{
    ...
    {
        public static CustomServiceRequestHeader GetCustomServiceRequestHeader(
            this ServiceRemotingMessageHeaders messageHeaders, IServiceRemotingLogger logger)
        {
            try
            {
                CustomServiceRequestHeader customServiceRequestHeader;
                if (CustomServiceRequestHeader.TryFromServiceMessageHeaders(messageHeaders,
                    out customServiceRequestHeader))
