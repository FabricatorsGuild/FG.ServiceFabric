...
namespace FG.ServiceFabric.Tests.Actor
{
    ...
    internal sealed class ActorDemoEventSource : EventSource
    {
        ...
        [Event(ServiceReplicaListenerMessageEventId, Level = EventLevel.Informational, Message = "{7}",
            Keywords = Keywords.ServiceReplicaListener)]
        ...
        [Event(ServiceReplicaListenerErrorEventId, Level = EventLevel.Error, Message = "{7}",
            Keywords = Keywords.ServiceReplicaListener)]
        ...
        [Event(ActorMessageEventId, Level = EventLevel.Informational, Message = "{9}",
            Keywords = Keywords.ActorImplementation)]
        ...
        [Event(ActorErrorEventId, Level = EventLevel.Error, Message = "{9} - {10}",
            Keywords = Keywords.ActorImplementation)]
        ...
        [Event(ActorDemoCountSetEventId, Level = EventLevel.Informational, Message = "{9}",
            Keywords = Keywords.ActorImplementation)]
        ...
        [Event(ActorDemoCountUpdatedEventId, Level = EventLevel.Informational, Message = "{9}",
            Keywords = Keywords.ActorImplementation)]
