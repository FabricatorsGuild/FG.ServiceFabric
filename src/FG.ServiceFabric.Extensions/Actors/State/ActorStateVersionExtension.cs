...
namespace FG.ServiceFabric.Actors.State
{
    ...
    {
        public static async Task<int> GetCurrentStateVersion(this IActorStateProvider stateProvider, ActorId actorId,
            string stateKey, string versionKey)
        {
            ...
            var currentStateVersionValue =
                await stateProvider.LoadStateAsync<int>(actorId, versionKey, CancellationToken.None);
