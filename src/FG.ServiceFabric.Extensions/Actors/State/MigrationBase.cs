...
namespace FG.ServiceFabric.Actors.State
{
    public abstract class MigrationBase<TState, TPredecessor>
    {
        ...
        protected abstract Task<TPredecessor> MigratePredecessor(int currentStateVersion, IActorStateProvider stateProvider, ActorId actorId, string stateKey, string versionKey);
