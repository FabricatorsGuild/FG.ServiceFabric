...
namespace FG.ServiceFabric.Actors.Runtime
{
    public abstract class WrappedActorStateProvider : IActorStateProvider
    {
        ...
        protected WrappedActorStateProvider(IActorStateProvider stateProvider = null,
        ...
        public virtual Task ActorActivatedAsync(ActorId actorId,
        ...
        public virtual Task<bool> ContainsStateAsync(ActorId actorId, string stateName,
            CancellationToken cancellationToken = new CancellationToken())
        {
            return _innerStateProvider.ContainsStateAsync(actorId, stateName, cancellationToken);
        }

        public virtual Task RemoveActorAsync(ActorId actorId,
            CancellationToken cancellationToken = new CancellationToken())
        {
            return _innerStateProvider.RemoveActorAsync(actorId, cancellationToken);
        }

        public virtual Task<IEnumerable<string>> EnumerateStateNamesAsync(ActorId actorId,
            CancellationToken cancellationToken = new CancellationToken())
        {
            return _innerStateProvider.EnumerateStateNamesAsync(actorId, cancellationToken);
        }

        public virtual Task<PagedResult<ActorId>> GetActorsAsync(int numItemsToReturn,
        ...
        public virtual Task<IActorReminderCollection> LoadRemindersAsync(
            CancellationToken cancellationToken = new CancellationToken())
        {
