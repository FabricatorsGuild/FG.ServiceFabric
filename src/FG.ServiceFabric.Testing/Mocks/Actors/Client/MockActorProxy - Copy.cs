...
////            {
////                return (method.DeclaringType == typeof(IActorProxy) ?
////                            interceptors.Where(i => i is ActorProxyInterceptor) :
////                            interceptors.Where(i => i is ActorInterceptor)).ToArray();
////            }
////        }
...
////                {
////                    returnTask.ContinueWith(t => this._actorManager?.AfterMethod(invocation.Proxy as IActor, invocation.Method));
////                }
////                else
////                {
