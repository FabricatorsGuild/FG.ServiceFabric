...
namespace FG.ServiceFabric.Testing.Setup
{
    internal class ApplicationProject
    {
        ...
        public static ApplicationProject Load(string applicationProjectPath)
        {
            ...
            var projectBasePath = Path.GetDirectoryName(applicationProjectPath);
            ...
            applicationProject.ApplicationManifestPath =
                noneIncludes.FirstOrDefault(i => i.EndsWith("ApplicationManifest.xml"));

            applicationProject.ApplicationManifestPath = applicationProject.ApplicationManifestPath ??
                                                         PathExtensions.GetAbsolutePath(projectBasePath,
